import "./style.css";
import myimg from "/Users/ghorakavisaranya/Desktop/MERN/reacttasks/react6/src/image/Saranya 10.57.27 AM 11.13.37 AM.jpg";
            ...
            <div ref={home} class="home">
                  <h3 class="heading">Home</h3>
                   <table>
                    ...
                    <h3 class="i1">I am Saranya Ghorakavi</h3>
                    <h3 class="i1">Welcome to my portfolio website</h3>
                    <h3 class="i1">My resume link <a href="https://drive.google.com/file/d/1kEbK1xdTapa3k_S6r0dY3OfoqA0fLzV4/view?usp=sharing" target="_blank" rel="noreferrer" >It's here</a></h3>
...
that.</h4>
            ...
            <div ref={contact} class="contact">
                ...
                <h4>Email me at gvnlsaranya2003@gmai.com</h4>
                <h4>Contact Number 9392790866</h4>
                <h4>My GitHub link <a href="https://github.com/Saranya1119">It's here</a></h4>
                <h4>Instagram Id @saranya1119</h4>
            </div>
        </div>
    )
}